...
const Products = () => {
    return (
    <div id="products" className="flex gap-20  flex-col 2xl:flex-row gap[128px] 2xl:gap-2 2xl:justify-between mt-[160px] 2xl:mt[270px] mb-[160px] max-w-[1490px] mx-auto px-10 w-full">
        ...
        <FadeIn delay={0.2} direction="right" >
            <div className="flex flex-col ">
                ...
                <button className="flex items-center gap-2 bg-transparent text-fontBlack border-transparent font-bold py-2 
                 px-4 rounded-lg w-fit border hover:border-black outline-none focus:outline-none ease-liner transition-all duration-350 mx-auto 
